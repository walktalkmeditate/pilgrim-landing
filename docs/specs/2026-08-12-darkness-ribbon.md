...
- **Band widths.** D1's boundaries are ≥1.0 mag apart everywhere except the top step (21.3, no upper bound) — comfortably wider than the ±0.32 mag swing, so no single sample can cross more than one boundary under the full range of α that clears Gate 0's own gate.
